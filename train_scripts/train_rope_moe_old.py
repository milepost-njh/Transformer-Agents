...
def train_model(
    ...
    writer = SummaryWriter(os.path.join(ckpt_dir, f"transformer_rope_{timestamp}"))
    ...
    for epoch in range(epochs):
        try:
            ...
            writer.add_scalar("train/loss", train_loss_meter.avg, global_step)
            writer.add_scalar("train/accuracy", train_acc_meter.avg, global_step)
            ...
            writer.add_scalar("val/loss", validate_loss, epoch + 1)
            writer.add_scalar("val/accuracy", validate_acc, epoch + 1)
